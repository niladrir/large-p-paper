...
To obtain a lineup with $m = 20$ plots for one dimensional projections for both random noise and data with real separation, we plot the one dimensional projections on the horizontal axis and a fixed value (say 1) on the vertical axis to obtain the actual data. 
