...
Figure \ref{suc-rate-glm} shows the proportion of the participants who successfully picked the plot of the actual data along with the 95\% adjusted Wald interval showed in form an error bar. We can clearly see when there is some real separation , the rate of success in making the correct response overall is higher than the rate of success when the data is complete noise and there is no real separation. Also there is not much difference in terms of the variability.
We notice that the rate of success is not very different for 1d and 2d projections. It can be noticed from Figure \ref{suc-rate-glm} that the error bars for 2d projections are little narrower than the error bars for 1d projections. 
%\subsection{1D vs 2D projections}
...
%\begin{figurehere}
   \centering
       \scalebox{0.8}{\includegraphics{time-taken-log.pdf}}
%        \scalebox{0.80}{\includegraphics{result-noise.pdf}}
