...
%To obtain the null plots, we permute the class variable breaking any dependence between the class variable and the other variables. Then the plot of the observed data is placed randomly among the null plots to obtain one lineup. 
