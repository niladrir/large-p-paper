...
%topic
{\color{red} Explanation of Projection Pursuit.} \\
...
%topic
{\color{red} Explanation of \texttt{tourr} package.} \\
...
%\begin{figurehere}
   \centering
       \scalebox{0.80}{\includegraphics{result-real.pdf}}
