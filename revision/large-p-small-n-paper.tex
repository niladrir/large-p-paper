...
%\begin{figurehere}
   \centering
       \scalebox{0.6}{\includegraphics{time-taken-log-bands.pdf}}
%        \scalebox{0.80}{\includegraphics{result-noise.pdf}}
