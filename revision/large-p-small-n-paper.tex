...
The authors conducted several experiments through Amazon Turk for different projects. Each experiment was conducted to test different hypothesis. The subjects from Amazon Turk are redirected to a website which describes the study elaborately.  The description includes the questions that the subjects has to respond to. The website also advices the subjects to try a few lineups before they actually participate in the experiment. The website of this turk study is available at \url{http://www.public.iastate.edu/~mahbub/feedback_turk7/homepage.html}.
